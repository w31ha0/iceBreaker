...
const NOTIFICATION_USER_BUSY = 'The other user is currently exchanging with another player!'
const NOTIFICATION_UNREGISTER_USER = 'You have successfuly unregistered from the game!'
...
module.exports = {
    ...
    NOTIFICATION_GAME_ALREADY_STARTED,NOTIFICATION_GAME_ALREADY_STOPPED,GAME_STATUS_INACTIVE,GAME_STATUS_IN_PROGRESS,PUSHER_GAME_COMPLETED_EVENT,USER_STATUS_IDLE,USER_STATUS_BUSY,
    NOTIFICATION_USER_BUSY,NOTIFICATION_UNREGISTER_USER
}